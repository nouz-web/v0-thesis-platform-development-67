    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:block">
              <h1 className="text-xl font-bold text-slate-800">Welcome to the Absence Management Platform</h1>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-slate-800 mb-4">Welcome to the Absence Management Platform</h2>
          ...
          <Link href="/login?role=admin" className="block">
            <Card className="h-full transition-all hover:shadow-md hover:border-slate-400">
              <CardHeader className="text-center pb-2">
                ...
                <CardDescription>For university administrative staff</CardDescription>
              </CardHeader>
          ...
          <Link href="/login?role=teacher" className="block">
            <Card className="h-full transition-all hover:shadow-md hover:border-slate-400">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="mt-4 text-xl">Teachers</CardTitle>
                <CardDescription>For university faculty members</CardDescription>
              </CardHeader>
              <CardContent className="text-sm text-slate-600">
                <ul className="list-disc list-inside space-y-1">
                  <li>Generate QR Code</li>
                  <li>View Attendance</li>
                  <li>Pending Justifications</li>
                  <li>Attendance Stats</li>
                </ul>
              </CardContent>
              <CardFooter>
                <Button className="w-full">Dashboard</Button>
          ...
          <Link href="/login?role=student" className="block">
            <Card className="h-full transition-all hover:shadow-md hover:border-slate-400">
              <CardHeader className="text-center pb-2">
                ...
                <CardDescription>For enrolled university students</CardDescription>
              </CardHeader>
              <CardContent className="text-sm text-slate-600">
                <ul className="list-disc list-inside space-y-1">
                  <li>Scan QR Code</li>
                  <li>My Absences</li>
                  <li>Submit Justification</li>
                  <li>Special Lessons</li>
                </ul>
              </CardContent>
              <CardFooter>
                <Button className="w-full">Dashboard</Button>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg text-center">
                    <p className="text-sm text-slate-600 mb-1">Today's Sessions</p>
                ...
                <div className="mt-6">
                  <h4 className="text-sm font-medium mb-2">Attendance Trends (Last 7 Days)</h4>
      ...
      <footer className="bg-slate-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-medium mb-4">Abbas Laghrour University Khenchela</h3>
